...
namespace TEModel
{
    class BoundaryCondition
    {
        ...
        public void Apply_Boundary_Conditions()
        {
            ...
            {
                // Left Side
                Node_Array[0, j].AE = 0.0f;
                Node_Array[0, j].AW = Node_Array[0, j].Node_Material.k * (Node_Array[0, j].delta_Y) / (Node_Array[0, j].d_X_W);
                ...
                Node_Array[0, j].b = T_Left + q_Left * Node_Array[0, j].delta_X + h_Left * Node_Array[0, j].delta_X * Tinf_Left + Node_Array[0, j].sc * Node_Array[0, j].delta_X * Node_Array[0, j].delta_Y * 0.5f * is_TBC_Left;

                // Right Side
                Node_Array[max_X, j].AE = Node_Array[max_X, j].Node_Material.k * Node_Array[max_X, j].delta_Y / Node_Array[max_X, j].d_X_E;
                Node_Array[max_X, j].AW = 0.0f;
                ...
                Node_Array[max_X, j].b = T_Right + q_Right * Node_Array[max_X, j].delta_X + h_Right * Node_Array[max_X, j].delta_X * Tinf_Right + Node_Array[max_X, j].sc * Node_Array[0, j].delta_X * Node_Array[max_X, j].delta_Y * 0.5f * is_TBC_Right;
